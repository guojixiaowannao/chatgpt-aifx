<template>
  <div class="person-card" :class="{ activeCard: personInfo.id == pcCurrent }">
    <div class="info">
      <HeadPortrait :imgUrl="personInfo.headImg" v-show="personInfo.headImg" />
      <div class="info-detail">
        <div class="name">{{ personInfo.name ? personInfo.name.slice(0, 20) : (personInfo.fineTunesStatus == "pending" ?
          "正在训练..." : "已取消") }}</div>
